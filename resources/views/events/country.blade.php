                                ...
                                @if($eventManufacturer->pivot->data_count > 0)
                                    ...
                                    <div class="row results cardc">
                                        ...
                                        <div class="col-md-4 donut-2">
                                            ...
                                            <p>{{ $eventManufacturer->pivot->appointments }} {{ __('Appointments') }}</p>
                                            <p>{{ $eventManufacturer->pivot->new + $eventManufacturer->pivot->used + $eventManufacturer->pivot->demo + $eventManufacturer->pivot->zero_km + $eventManufacturer->pivot->inprogress }} {{ __('Sales') }}</p>
                                        </div>
    ...
    @if($eventManufacturer->id == $manufacturer->id)
        ...
        @if($eventManufacturer->pivot->data_count > 0)
            ...
            new Chart(document.getElementById("{{ str_replace(' ','-',strtolower($manufacturer->name)) }}-bar-chart-grouped"), {
                ...
                data: {
                    labels: ["{{ __('Response') }}", "{{ __('Conversion') }}"],
                    datasets: [
                ...
                options: {
                    title: {
                        display: true,
                        text: "{{ __('Response and Conversion Rate') }}"
                    },
                    scales: {
                        yAxes: [{
                            display: true,
